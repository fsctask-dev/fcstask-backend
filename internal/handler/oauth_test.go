...
func TestOAuthExchange_LinkedIdentity_SignsInWithoutRegistrationToken(t *testing.T) {
	...
	env.sessions.On("CreateSession", mock.Anything, mock.MatchedBy(func(s *models.Session) bool {
...
func TestOAuthCompleteSignUp_Success(t *testing.T) {
	...
	env.users.On("ExistsUserByEmail", mock.Anything, "ivan@example.com").Return(false, nil)
	env.users.On("ExistsUserByUsername", mock.Anything, "ivan").Return(false, nil)
	env.users.On("CreateUser", mock.Anything, mock.MatchedBy(func(u *models.User) bool {
...
func TestOAuthCompleteSignUp_EmailTaken(t *testing.T) {
	...
	env.users.On("ExistsUserByEmail", mock.Anything, "ivan@example.com").Return(true, nil)
