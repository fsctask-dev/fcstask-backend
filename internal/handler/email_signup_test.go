...
func TestSignUp_Submit_EmailConflict(t *testing.T) {
	env := newSignUpEnv(t)
	env.users.On("ExistsUserByEmail", mock.Anything, "taken@example.com").Return(true, nil)
...
func TestSignUp_Verify_Success(t *testing.T) {
	...
	env.sess.On("CreateSession", mock.Anything, mock.MatchedBy(func(s *models.Session) bool {
